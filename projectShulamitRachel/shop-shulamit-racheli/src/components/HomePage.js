...
const HomePage = () => {
    ...
    const productsType = [{emoji: '🧩 ', boldText: 'פסיפסים בהזמנה אישית', plainText:' – כל אחד מהם הוא יצירת אמנות'}, {emoji: '🖼️ ', boldText: 'קישוטי קיר', plainText:' – צבעוניים, ייחודיים ומלאי אופי'}, {emoji: '🪴 ', boldText: 'עציצים מעוצבים', plainText:' – מתנה מושלמת לעצמך או לחבר'}, {emoji: '💡 ', boldText: 'גופי תאורה', plainText:' – שעושים אור גם בלב'}, {emoji: '🍕 ', boldText: 'מגשים לאוכל', plainText:' – שהאוכל יוגש עם סטייל'}, {emoji: '✨ ', boldText: '', plainText:'עוד המון הפתעות קטנות וצבעוניות – כל אחת שונה, כל אחת עם סיפור...'}]
